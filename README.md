...
**当前版本：`v15.0.3-ladder-tv-flat-ding`**  
**TV 策略 schema：`v6.5.6`**  
...
# version: v15.0.3-ladder-tv-flat-ding
...
```
TV 到达 → 先平干净 → 按风险公式开仓 → 挂 TP1+TP2 + stop_loss
       → 阶梯雷达候命(WS) → 钉钉确认
```
...
| **防螺旋** | 未成交 TP 取消移交雷达禁重挂；60s 去重；改单重试 3 次 |
...
版本：`v15.0.3-ladder-tv-flat-ding`
---
...
# 期望: v15.0.3-ladder-tv-flat-ding
...
*GEMINI Quant · v15.0.3-ladder-tv-flat-ding / TV v6.5.6*

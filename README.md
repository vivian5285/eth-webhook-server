...
**当前版本：`v13.68.0-tp-fill-consume-guard`**  
...
# 期望 version 含 v13.68.0-tp-fill-consume-guard
...
- **TP 成交禁补挂**（v13.68）：头寸减少+限价消失 → 先记账 `tp_levels_consumed`；**禁止**把已成交档当漏挂按现仓重挂（修 R4 TP1=5% 循环吃单）
...
# 期望: v13.68.0-tp-fill-consume-guard
...
# version 含 v13.68.0 · tv_strategy 含 v6.9.108

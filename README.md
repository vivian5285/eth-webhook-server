...
> **防叠铁律（v15.7.6）**：挂单不可读 → 禁止谎称「已有硬止损」；禁止重建/核武/盲撤；撤 TP 不可 `cancel_all` 误伤 STOP；同价 LIMIT 轻量去重。
...
# version: v15.7.6-iron-dup · sizing: RISK20_NOTIONAL5 · trading_paused: false

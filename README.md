...
# 期望 version 含 v13.82.0-tv-risk-sizing
...
# version 含 v13.82.0 · tv_strategy 含 v6.9.108
...
> 当前修复版本基准：**`v13.82.0-tv-risk-sizing`**（TV 唯一仓位公式；含 v13.75～v13.81 硬止损/防线铁律）。
...
| 4 | **开仓必须有 TP123 + TV 硬止损** | 缺任一视为裸仓；终检 `_force_hang_open_defenses` 闭环补挂；钉钉告警。雷达开仓后仅待命，不替代硬止损。 |
...
*GEMINI Quant · 双轨智慧雷达 · v13.82.0-tv-risk-sizing*

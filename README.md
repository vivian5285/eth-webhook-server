...
**当前版本：`v13.71.0-open-only-no-instant-trim`**  
...
# 期望 version 含 v13.71.0-open-only-no-instant-trim
...
- **开仓宽限禁档位裁减**（v13.71）：刚开仓内不做 regime_cap 减仓；钉钉同行为 20s 去重
...
# 期望: v13.71.0-open-only-no-instant-trim
...
# version 含 v13.71.0 · tv_strategy 含 v6.9.108

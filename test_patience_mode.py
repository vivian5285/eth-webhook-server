...
class TestZoneEngage(unittest.TestCase):
    ...
    def _zone(self, price, best, coeff=5.0, tp2=None, tp3=None):
        ...
        return BS._zone_trail_atr(
            ...
            profile=PROF, coeff=coeff, tp1_px=tp1, tp2_px=tp2, tp3_px=tp3, best=best,
        )
...
class TestRealPathPatienceVsNoPatience(unittest.TestCase):
    ...
    def _replay(self, seg, entry, atr, tp1, tp2, tp3):

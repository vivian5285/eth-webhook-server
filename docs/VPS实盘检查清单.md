...
> **当前**：TV **v6.5.6** · VPS **v15.0.7-tp123-hang** · sizing **RISK20_NOTIONAL5**  
...
| 4 | TP **30/30/40** 硬编码，盘口挂 **TP1+TP2+TP3**（价格用 TV）；与雷达先到先得 | `LEG_TP_RATIOS` · `PLACE_TP_LEVELS=3` |
